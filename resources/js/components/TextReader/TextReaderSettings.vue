                ...
                <v-row>
                    ...
                    <v-col cols="4" md="8" class="switch-container d-flex align-center mt-0 pt-3 justify-end">
                        <v-switch
                            ...
                            @change="settingChanged('highlightWords', highlightWords)"
                        ></v-switch>
                    </v-col>
                </v-row>
                ...
                <v-row>
                    ...
                    <v-col cols="4" md="8" class="switch-container d-flex align-center mt-0 pt-3 justify-end">
                        <v-switch
                            ...
                            @change="settingChanged('japaneseText', japaneseText)"
                        ></v-switch>
                    </v-col>
                </v-row>
                ...
                <v-row>
                    ...
                    <v-col cols="4" md="8" class="switch-container d-flex align-center mt-0 pt-3 justify-end">
                        <v-switch
                            ...
                            @change="settingChanged('autoMoveWordsToKnown', autoMoveWordsToKnown)"
                        ></v-switch>
                    </v-col>
                </v-row>
            </v-card-text>
