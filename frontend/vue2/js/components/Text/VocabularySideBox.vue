    ...
    >
        ...
        <div class="pa-0 w-full" v-if="type !== 'empty'">
            ...
            <div class="vocab-box-subheader d-flex mb-2">
                ...
                <!-- Back button -->
                <v-btn v-if="tab > 0" icon title="Back to word" @click="tab = 0">
        ...
        <v-tabs-items v-model="tab" v-if="type !== 'empty'">
            ...
            <v-tab-item :value="0" class="sidebar-tab">
                ...
                <!-- Translation -->
                <div class="vocab-box-subheader d-flex">Translation</div>
                <v-textarea
                    class="mb-2 mt-1"
...
export default {
    ...
    methods: {
        ...
        updateDataFromStore() {
            ...
            for (
                let wordIndex = 0;
                wordIndex < this.$store.state.vocabularyBox.phrase.length;
                wordIndex++
            ) {
        ...
        inputChanged(inputName = '') {
            ...
            if (
                ...
                this.$store.state.vocabularyBox.stage >= 0 &&
