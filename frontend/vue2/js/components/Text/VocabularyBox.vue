    ...
    >
                ...
                <v-tab-item :value="0">
                    <v-card-text class="pa-0">
                        ...
                        <template v-if="type === 'word'">
                            <div class="vocab-box-subheader mb-2 mt-0">
                        ...
                        <template v-if="type !== 'word'">
                            <div class="vocab-box-subheader mb-2 mt-0">
                                <span class="rounded-pill py-1 px-3">Phrase</span>
                            </div>
                            <!-- Phrase text -->
        ...
        <div class="vocab-box-toolbar d-flex flex-column align-center flex-wrap pt-1 rounded-r-lg">
            ...
            <v-btn
                ...
                title="Send to anki"
                ><v-icon class="mr-1">mdi-cards</v-icon></v-btn
            >
            <v-btn
                icon
            ...
            <v-menu open-on-hover nudge-top="-44px" left v-if="tab == 0">
                <template v-slot:activator="{ on, attrs }">
                    <v-btn icon title="Add or edit image" v-bind="attrs" v-on="on" @click="tab = 3">
